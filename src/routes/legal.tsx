...
const legalCopy: Record<Locale, LegalCopy> = {
  ru: {
    ...
    sections: [
      { id: "privacy", title: "1. Политика конфиденциальности", paragraphs: ["Ответственный за обработку данных: Jelena Gutseva. Контакт по вопросам данных: artjomszemlickis@gmail.com.", "Сайт собирает только данные, которые посетитель самостоятельно передаёт при записи. Данные не продаются и не используются для рекламной рассылки без отдельного согласия."] },
      ...
      { id: "complaints", title: "8. Вопросы и претензии", paragraphs: ["Сначала напишите на artjomszemlickis@gmail.com — обращение будет рассмотрено в разумный срок. Если спор не решён, потребитель может обратиться в Комиссию по потребительским спорам при TTJA или использовать другие предусмотренные законом способы защиты."] },
    ],
  },
  en: {
    ...
    sections: [
      { id: "privacy", title: "1. Privacy notice", paragraphs: ["Data controller: Jelena Gutseva. Privacy contact: artjomszemlickis@gmail.com.", "The site collects only information submitted by the visitor for a booking. Data is not sold or used for marketing without separate consent."] },
      ...
      { id: "sharing", title: "4. Recipients and retention", paragraphs: ["The site may use Vercel for hosting, a database provider and Resend for message delivery. Each receives only the data needed for its function.", "Booking records are kept for up to 12 months and then deleted unless longer retention is required by law or for legal claims. Email correspondence may be retained separately until the communication and relevant obligations are complete."] },
      { id: "rights", title: "5. Your rights", items: ["Request access, correction or deletion.", "Request restriction, object or request portability where applicable.", "Withdraw health-data consent without retrospective effect.", "Complain to the Estonian Data Protection Inspectorate (Andmekaitse Inspektsioon)."], paragraphs: ["Send requests to artjomszemlickis@gmail.com. Identity verification may be required before acting on a request."] },
      ...
      { id: "complaints", title: "8. Questions and complaints", paragraphs: ["Contact artjomszemlickis@gmail.com first. If no solution is reached, consumers may contact the Consumer Disputes Committee at TTJA or use another remedy available by law."] },
    ],
  },
  et: {
    ...
    sections: [
      { id: "privacy", title: "1. Privaatsustingimused", paragraphs: ["Isikuandmete vastutav töötleja on Jelena Gutseva. Andmekaitseküsimused: artjomszemlickis@gmail.com.", "Veebileht kogub ainult broneerimiseks vabatahtlikult esitatud andmeid. Andmeid ei müüda ega kasutata turunduseks ilma eraldi nõusolekuta."] },
      ...
      { id: "complaints", title: "8. Küsimused ja kaebused", paragraphs: ["Kirjutage esmalt aadressile artjomszemlickis@gmail.com. Kui lahendust ei leita, võib tarbija pöörduda TTJA tarbijavaidluste komisjoni või kasutada muud seadusest tulenevat õiguskaitsevahendit."] },
    ],
  },
};
